...
export default {
  ...
  description: "Create MPLS 2025 twibbon with a circular photo frame",
  category: "Maker",
  methods: ["POST"],
  params: ["file"],
  paramsSchema: {
  ...
  async run(req, res) {
    try {
      ...
      res.setHeader("Content-Disposition", 'inline; filename="twibbon-mpls-2025.png"');
      res.send(buffer);
